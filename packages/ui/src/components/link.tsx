...
const linkVariants = cva(
	"inline-flex items-baseline group-hover:text-secondary group-hover:cursor-pointer hover:text-secondary hover:cursor-pointer text-md lg:text-lg underline-none gap-1",
	{
		variants: {
			variant: {
