...
const SocialLinkGroup = ({ orientation, className }: { orientation: "horizontal" | "vertical"; className?: string }) => {
	if (orientation === "horizontal") {
		return (
			<ul className={className + " flex w-full gap-x-12 md:gap-x-16"}>
				<li>
					<a href={GITHUB_URL} target="_blank">
						<GitHubSvg className="w-5 h-5 md:w-6 md:h-6 hover:text-accent transition-[fill] duration-200 ease-in" />
					</a>
				</li>
				<li>
					<a href={LINKEDIN_URL} target="_blank">
						<LinkedInSvg className="w-5 h-5 md:w-6 md:h-6 hover:text-accent transition-[fill] duration-200 ease-in" />
					</a>
				</li>
				<li>
					<a href={"mailto:" + EMAIL_ADDRESS} target="_blank">
						<EmailSvg className="w-5 h-5 md:w-6 md:h-6 hover:text-accent transition-[fill,color] duration-200 ease-in" />
					</a>
				</li>
			</ul>
		);
		...
		return (
			<ul className={className + " flex flex-col gap-y-12"}>
				<li>
					<a href={GITHUB_URL} target="_blank">
						<GitHubSvg className="w-5 h-5 md:w-6 md:h-6 hover:text-accent transition-[fill] duration-200 ease-in" />
					</a>
				...
				<li>
					<a href={"mailto:" + EMAIL_ADDRESS} target="_blank">
						<EmailSvg className="w-5 h-5 md:w-6 md:h-6 hover:text-accent transition-[fill] duration-200 ease-in" />
					</a>
				</li>
			</ul>
		);
