    ...
    >
      ...
      <div className="prose prose-lg dark:prose-invert text-gray-600 dark:text-gray-300 max-w-none">
        <p>
          ...
          systems and bridges between complex data and elegant user experiences.
        </p>
        <p className="mt-4">
          (This section will gracefully slide up and fade into view right before
          it hits the center of your screen!)
        </p>
      </div>
    </motion.section>
  );
