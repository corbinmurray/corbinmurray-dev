...
import { AppShell, Burger, Button, Center, Container, Flex, Group, Stack, Text, Title } from "@mantine/core";
		...
		<AppShell
			...
			<AppShell.Main p="xl">
				<Container p={0} m={0}>
					...
					<footer>
						<Stack className={clsx(classes["margin-top-lg"])}>
							<Center>
								<Title order={1} size="clamp(26px,5vw,32px)" textWrap="nowrap">
									Contact Me
									<svg className={clsx(classes.exclamation)} viewBox="0 0 18.55445 54.01644">
										<path
							...
							<Center>
								<Button
									...
									maw={200}
									rightSection={
										<svg className={classes.message} viewBox="0 0 55.59259 56.25544">
											<path
									...
									Say Hello
										...
										<br />
						<Group mt="xl" justify="center" align="center" gap="xl">
							<GitHubSvg className={classes["social-link"]} />
							<LinkedInSvg className={classes["social-link"]} />
							<EmailSvg className={classes["social-link"]} />
						</Group>
